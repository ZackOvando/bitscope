    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Thanks for joining the waitlist for BitScope! I'm Zack Ovando, the developer behind this project. I'm glad to
          have you on board.
        </Text>
        <Text style={paragraph}>
          ...
          <a href="mailto:ovandozack@gmail.com" style={link}>
            this email {""}
          </a>
          — I'm here to listen!
        </Text>
        <Text style={paragraph}>
          ...
          <a href="https://x.com/heyzackovando" style={link}>
            @heyzackovando
          </a>
        </Text>
        <Text style={signOff}>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          You received this email because you signed up for the Bitscope waitlist.
